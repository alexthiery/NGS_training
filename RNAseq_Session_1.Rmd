...
We can save the output of the final pairwise differential test for our next session on visualisation  of heatmaps and volcano plots
``` {r}
saveRDS(res, '~/Downloads/MCF7_vs_H1_pairwise_results.RDS')
```
